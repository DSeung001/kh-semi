...
<head>
  ...
  <meta name="description" content="여행 사진을 모아 보는 Travelgram 페이지">
  <title>나만의 여행 일기 | Travelgram</title>
...
<a href="${pageContext.request.contextPath}/travelgram.jsp" class="active" aria-label="travelgram"><i class="bi bi-grid-3x3-gap"></i></a>
...
<jsp:include page="/components/sidebar.jsp">
  <jsp:param name="activePage" value="travelgram" />
</jsp:include>

    <main class="tg-content">
      
<header class="tg-panel tg-travelgram-title">
  <span class="tg-muted small d-block">travelgram</span>
  나만의 여행 일기
</header>
...
<section class="tg-travel-grid" aria-label="나만의 여행 사진 그리드">
  <a class="tg-grid-card " href="${pageContext.request.contextPath}/post-detail.jsp">
...
<a class="tg-grid-card narrow" href="${pageContext.request.contextPath}/post-detail.jsp">
