...
<a href="${pageContext.request.contextPath}/chat.jsp" class="active" aria-label="chat"><i class="bi bi-chat-dots"></i></a>
...
<section class="tg-panel tg-chat-shell">
  <header class="tg-chat-header d-flex align-items-center justify-content-between">
    <div>
      <h1 class="h5 mb-1">Talk for Travel</h1>
      <p class="tg-muted tg-small mb-0">실시간으로 여행 정보와 동선을 나눠보세요.</p>
    </div>
    <span class="tg-chip"><i class="bi bi-circle-fill text-success"></i> 18명 접속</span>
  </header>

  <div class="tg-chat-list">
    <article class="tg-chat-item">
      ...
      <div>
        <div class="d-flex gap-2 align-items-center mb-1">
          ...
          <span class="tg-muted small">14:18</span>
        </div>
        <div class="tg-chat-bubble">
    ...
    <article class="tg-chat-item">
      <img class="tg-avatar" src="${pageContext.request.contextPath}/assets/images/profile-min.svg" alt="budget_min 프로필">
      <div>
        <div class="d-flex gap-2 align-items-center mb-1">
          <strong class="small">budget_min</strong>
          <span class="tg-muted small">14:20</span>
        </div>
        <div class="tg-chat-bubble">
    ...
    <article class="tg-chat-item">
      ...
      <div>
        <div class="d-flex gap-2 align-items-center mb-1">
          ...
          <span class="tg-muted small">14:23</span>
        </div>
        <div class="tg-chat-bubble">
  ...
  <form class="tg-chat-compose" data-demo-form data-message="메시지 전송 데모입니다.">
    <div class="input-group">
      ...
      <button class="btn btn-primary tg-primary-btn" type="submit">전송</button>
    </div>
  </form>
</section>
