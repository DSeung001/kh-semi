...
<head>
  ...
  <meta name="description" content="Travelgram 회원가입 페이지">
  <title>회원가입 | Travelgram</title>
...
<div class="tg-auth-wrap">
  <section class="tg-panel tg-auth-card tg-panel-shadow">
    ...
    <form class="row g-3" data-demo-form data-message="회원가입 데모입니다." data-redirect="${pageContext.request.contextPath}/login.jsp">
      <div class="col-12">
    ...
    <p class="text-center small mt-4 mb-0">이미 계정이 있나요? <a class="text-primary fw-bold" href="${pageContext.request.contextPath}/login.jsp">로그인</a></p>
  </section>
</div>
