...
<a href="${pageContext.request.contextPath}/post/travelgram.jsp" class="" aria-label="travelgram"><i class="bi bi-grid-3x3-gap"></i></a>
...
<section class="tg-panel tg-story-strip" aria-label="여행 스토리">
  <a class="tg-story" href="${pageContext.request.contextPath}/tag.jsp">
...
<article class="tg-panel tg-post">
  <header class="tg-post-header">
    ...
    <div class="tg-user-meta">
      <strong><a href="${pageContext.request.contextPath}/profile.jsp">travel_ethan</a></strong>
      <span>서울 · 2시간 전</span>
    </div>
    <button class="tg-icon-btn fs-5" type="button" aria-label="더보기"><i class="bi bi-three-dots"></i></button>
  </header>
  <a href="${pageContext.request.contextPath}/post-detail.jsp">
  ...
  <div class="tg-post-actions">
    ...
    <a class="tg-icon-btn" href="${pageContext.request.contextPath}/post-detail.jsp#comments" aria-label="댓글"><i class="bi bi-chat"></i></a>
  ...
  <div class="tg-post-body">
    ...
    <p><strong class="me-1">travel_ethan</strong>교통비 포함 2만 원으로 서울 하루 여행을 다녀왔습니다. <a class="tg-hashtag" href="${pageContext.request.contextPath}/tag.jsp">#서울여행 #가성비여행 #여행기록</a></p>
    <a class="tg-muted d-block mb-1" href="${pageContext.request.contextPath}/post-detail.jsp#comments">댓글 모두 보기</a>
...
<article class="tg-panel tg-post">
  <header class="tg-post-header">
    ...
    <div class="tg-user-meta">
      <strong><a href="${pageContext.request.contextPath}/profile.jsp">travel_sora</a></strong>
      <span>제주 · 2시간 전</span>
    </div>
    <button class="tg-icon-btn fs-5" type="button" aria-label="더보기"><i class="bi bi-three-dots"></i></button>
  </header>
  ...
  <div class="tg-post-body">
    ...
    <p><strong class="me-1">travel_sora</strong>비가 와도 좋았던 제주 동쪽 작은 마을 산책. <a class="tg-hashtag" href="${pageContext.request.contextPath}/tag.jsp">#제주여행 #혼자여행 #travelgram</a></p>
    <a class="tg-muted d-block mb-1" href="${pageContext.request.contextPath}/post-detail.jsp#comments">댓글 모두 보기</a>
    <div data-comment-list></div>
    <small class="tg-muted">2026년 7월 20일</small>
  </div>
