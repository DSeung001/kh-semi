...
if (followButton) {
    followButton.addEventListener("click", async () => {
        ...
        try {
            ...
            const newFollowingState = Boolean(result.data);

            followButton.dataset.following = String(newFollowingState);

            followButton.textContent = newFollowingState ? "팔로잉" : "팔로우";
            followButton.classList.toggle("is-following", newFollowingState);
