  ...
  <div class="zt-layout">
    ...
    <main class="zt-content">
      ...
      <header class="zt-page-header">
        <h1>진행 중인 미션</h1>
        <!-- 컨트롤러에서 넘긴 미션 객체의 데이터가 있다면 출력, 없으면 기본 문구 출력 -->
        <p data-active-mission-title>
          ${not empty mission ? mission.title : '만원으로 서울 하루 여행'}
        </p>
      </header>
      ...
      <section class="zt-panel zt-profile-card">
        ...
        <div class="mb-4">
          <div class="d-flex justify-content-between mb-2">
            ...
            <span class="zt-muted">
        ${not empty mission ? mission.completedCount : 2} / ${not empty mission ? mission.totalCount : 4}
      </span>
          </div>

          <%-- 진행률 퍼센트를 동적으로 바디 스타일에 반영 --%>

          <c:set var="progress" value="${not empty mission ? mission.progressPercent : 50.0}" />
          <div class="progress zt-mission-progress" role="progressbar" aria-label="미션 진행률" aria-valuenow="${progress}" aria-valuemin="0" aria-valuemax="100">
